/**
 * FALLEN SELFBOT - Main Entry Point
 *
...
function displayBanner() {
  try {
    ...
    console.log(chalk.cyan("> ") + chalk.gray("Support server: https://discord.gg/ypXHdGQaq"));
    console.log(
      chalk.cyan("> ") +
        chalk.gray("Use at your own risk - selfbots violate Discord's ToS")
    );
    console.log(chalk.cyan("> ") + chalk.gray("Developed by svrOx."));
    console.log("\n");
  } catch (error) {
