  ...
  async updatePresence(client, customConfig = null) {
    ...
    try {
      ...
      if (rpcData.assets?.large_image) {
        ...
        const processed = this.processImageAsset(resolved);
        if (processed) {
